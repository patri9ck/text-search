...
Zum Beispiel wird bei der Ausführung der main() function gespeichert welche Suche lief (bspw: Standard lib find())
welcher String gesucht wurde, welche Zeit und so weiter.
